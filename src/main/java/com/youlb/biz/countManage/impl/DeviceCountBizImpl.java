...
//		List<String> slist = deviceCountSqlDao.pageFindBySql(sql, new Object[]{deviceCount.getTreecheckbox().get(0)});
     ...
     */
	@Override
	public void updateById(String endTime,String ramdonCode,String orderNum,String id) {
		String hql ="update DeviceCount set endTime=?,ramdonCode=?,orderNum=?,createTime=? where id=?";
		deviceCountSqlDao.update(hql, new Object[]{endTime,ramdonCode,orderNum,new Date(),id});
	}
	/**获取地址信息
	 * @param cardInfo
	 * @return
