...
<%-- 		   <input type="hidden" id="infoPublishDomainIds" value="${infoPublish.treecheckbox}"/> --%>
           ...
           <table>
              <tr>
                <td><div class="firstFont"><span class="starColor">*</span>截止日期：&nbsp;&nbsp;&nbsp;&nbsp;</div></td>
                <td><div><input name="expDateStr" readonly="readonly" class="form-control datepicker" title="截止日期不能为空！" value="${infoPublish.expDateStr}"/></div></td>
              </tr>
           </table>
           <table>
              <tr>
