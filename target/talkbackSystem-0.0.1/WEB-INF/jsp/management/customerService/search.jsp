...
<body>
    ...
    <div class="searchInfoDiv">
          <form id="customerServiceSearchForm" action="" method="post">
           <input type="hidden" class="hiddenId" name="id" value="${id}"/>
           <input type="hidden" class="hiddenId" name="orderNature" value="${parentId}"/>
           <table>
              <tr>
                <td><div class="firstFont">编号：</div></td>
                <td><div><input name="orderNum" class="form-control"/></div></td>
                <td><div class="leftFont">姓名：</div></td>
                <td><div><input name="custName" class="form-control"/></div></td>
              ...
              <tr>
                ...
                <td><div class="leftFont"><button class="btn btn-info btn-sm search" rel="${path}/mc/customerService/showList.do">查询</button></div></td>
              </tr>
           </table>
        </form>
       </div>  
      <div class="searchInfoDiv tableTitle">
        <table>
             <tr>
                ...
                <td><div class="customerServiceFinish">${finish}</div></td>
                <td><div class="leftFont">未处理工单：</div></td>
                <td><div class="customerServiceUnfinish">${unfinish}</div></td>
              </tr>
          </table>
      </div>
</body>
